...
namespace Bombones.IoC
{
    public static class DI
    {
        public static IServiceProvider ConfigurarServicios()
        {
            ...
            service.AddScoped<IRepositorioProvedores, RepositorioProvedores>();
            service.AddScoped<IServiciosProvedores, ServiciosProvedores>();

            service.AddScoped<IRepositorioEmpleados, RepositorioEmpleados>();
            service.AddScoped<IServiciosEmpleados, ServiciosEmpleados>();

            service.AddScoped<IServiciosProvedores>(sp =>
            {
                var repositorio = new RepositorioProvedores();
                return new ServiciosProvedores(repositorio, cadena);
            });
