        ...
        public static void SetearFila(DataGridViewRow r, object obj)
        {
            switch (obj)
            {
                ...
                case BombonListDto bombon:
                    ...
                    break;
                case Provedores provedor:
                    r.Cells[1].Value = provedor.NombreProvedor;
                    r.Cells[2].Value = provedor.Telefono;
                    r.Cells[3].Value = provedor.Email;
                    break;
                case EmpleadosListDto em:
                    r.Cells[0].Value = em.NombreEmpleado;
                    r.Cells[1].Value = em.ApeelidoEmpleado;
                    r.Cells[2].Value = em.FechaContratacion;
                    r.Cells[3].Value = em.Direccion;
                    r.Cells[4].Value = em.NombreCiudad;
                    r.Cells[5].Value = em.NombreProvinciaEstado;
                    r.Cells[6].Value = em.NombrePais;
                    break;
                default:
                    break;
            }
